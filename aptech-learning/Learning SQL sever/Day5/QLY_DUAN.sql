...
SELECT MA_NV,HOTEN,GT,LUONG FROM NHAN_VIEN


SELECT MA_NV +' '+ HOTEN AS "NHAN_VIEN_CTY", GT FROM NHAN_VIEN 

SELECT distinct HOTEN FROM NHAN_VIEN

SELECT TOP 2 * FROM NHAN_VIEN

SELECT * FROM NHAN_VIEN WHERE (HOTEN LIKE '%Lê%')
	AND (MA_NV = 4)

SELECT * FROM NHAN_VIEN WHERE (HOTEN LIKE '%Lê%')
	OR (MA_NV = 4)

SELECT * FROM NHAN_VIEN WHERE (LUONG >1600000)

SELECT * FROM NHAN_VIEN WHERE LUONG between 4000000 and 1000000

SELECT AVG(LUONG) AS "LUONG TB NV" FROM NHAN_VIEN 

SELECT MIN(LUONG) AS "MUC LUONG NHO NHAT" FROM NHAN_VIEN

SELECT HOTEN, min(LUONG) AS "NGAY LAM IT NHAT" FROM NHAN_VIEN group by HOTEN

SELECT * FROM NHAN_VIEN ORDER BY MA_NV DESC

SELECT * FROM NHAN_VIEN ORDER BY MA_NV ASC

SELECT TOP 2 * FROM NHAN_VIEN ORDER BY LUONG DESC
