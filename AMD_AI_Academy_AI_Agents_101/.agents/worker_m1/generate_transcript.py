...
# -*- coding: utf-8 -*-
"""
Script to generate the authoritative bilingual transcript for:
AMD AI Academy: AI Agents 101 - Building AI Agents with MCP & Open-Source Inference
"""

import sys

content = """# 🎙️ Bản Phiên Âm & Bản Dịch Kỹ Thuật: AMD AI Academy — AI Agents 101
...
target_path = "/Volumes/KINGSTON/02_Learning_Knowledge/AMD_AI_Academy_AI_Agents_101/02_Notes_Summaries/transcript.md"
with open(target_path, "w", encoding="utf-8") as f:
    f.write(content.strip() + "\\n")

print(f"Successfully generated transcript.md at {target_path}")
